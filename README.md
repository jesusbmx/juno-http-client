...
dependencies {
  ...
  implementation 'com.github.jesusbmx:juno-http-client:1.5.7'
}
```
...
Download [juno-http-client.jar](https://jitpack.io/com/github/jesusbmx/juno-http-client/1.5.7/juno-http-client-1.5.7.jar)
