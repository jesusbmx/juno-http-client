...
dependencies {
  ...
  implementation 'com.github.jesusbmx:juno-http-client:1.5.5'
}
```
...
Download [juno-http-client.jar](https://jitpack.io/com/github/jesusbmx/juno-http-client/1.5.5/juno-http-client-1.5.5.jar)
